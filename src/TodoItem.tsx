  ...
  return (
    <div className="flex items-center justify-between group bg-white border border-slate-100 p-3 rounded-xl hover:border-[#ed7455] transition-all">
      <div className="flex items-center gap-3 flex-1">
        ...
        {isEditing ? (
          <input 
            className="flex-1 bg-transparent border-none outline-none p-0 text-base font-medium text-slate-700 focus:ring-0"
            value={editText}
      ...
      <div className="flex items-center gap-1">
        {isEditing ? (
          <>
            {/* Save */}
            <button onClick={handleSave} className="text-slate-300 hover:text-green-500 p-1 transition-colors cursor-pointer">
